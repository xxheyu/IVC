function Reconstructed_imagenew =IntraDecodenew(output,rowsize,columnsize,factor,option)
...
Reconstructed_imagenew(:,:,1)=Reconstructed_image(:,:,1);
Reconstructed_imagenew(:,:,2)=Reconstructed_image(:,:,2);
Reconstructed_imagenew(:,:,3)=Reconstructed_image(:,:,3);
